...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.headerItem().setText(6, _translate("MainWindow", "Stop Track", None))
        self.treeWidget.headerItem().setToolTip(6, _translate("MainWindow", "Stop tracking the file in the manifest", None))
        self.treeWidget.headerItem().setText(7, _translate("MainWindow", "Delete", None))
        self.treeWidget.headerItem().setToolTip(7, _translate("MainWindow", "Delete this file from the local filesystem", None))
        self.treeWidget.headerItem().setText(8, _translate("MainWindow", "No Op", None))
        self.treeWidget.headerItem().setToolTip(8, _translate("MainWindow", "Do nothing", None))
